...
state_count = st.sidebar.slider('Top number of states to display', min_value=5, max_value=25, value=10, step=2)
...
with row0_2:
    st.text("")
    st.subheader('Streamlit App by [Bria Gibson](https://www.linkedin.com/in/bria-gibson-ba0573188/)')
row3_spacer1, row3_1, row3_spacer2 = st.columns((.1, 3.2, .1))
with row3_1:
    st.markdown("Have you ever wondered how often a UFO is sighted across the country? Check out these interesting statistics from the year 2016!")

#Create vertical space
st.write(" ")
st.write(" ")
st.write(" ")
st.subheader('Count of UFO Sightings by State') 
